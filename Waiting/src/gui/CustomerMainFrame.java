...
//	private JTextField peopleNum;
	...
	public CustomerMainFrame() throws Exception {
		...
		txtrAsdf.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		textArea_1.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		textArea_2.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		textArea_4.setFont(new Font("맑은 고딕", Font.PLAIN, 13));
		...
		textArea_5.setFont(new Font("맑은 고딕", Font.PLAIN, 8));
		...
		wait.setFont(new Font("맑은 고딕", Font.BOLD, 48));
		...
		textArea_6.setFont(new Font("맑은 고딕", Font.BOLD, 24));
		...
		textArea_3.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		b6.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		b7.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		b7.setBounds(487, 304, 72, 52);
		panel.add(b7);
		
		JButton b8 = new JButton("8");
		b8.setBackground(Color.WHITE);
		b8.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		b8.setBounds(560, 304, 72, 52);
		panel.add(b8);
		
		JButton b9 = new JButton("9");
		b9.setBackground(Color.WHITE);
		b9.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		bok.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		bok.setBounds(633, 357, 72, 52);
		panel.add(bok);
		
		JButton b0 = new JButton("0");
		b0.setBackground(Color.WHITE);
		b0.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		b0.setBounds(560, 357, 72, 52);
		panel.add(b0);
		
		JButton bback = new JButton("\u25C0");
		bback.setBackground(Color.WHITE);
		bback.setFont(new Font("맑은 고딕", Font.BOLD, 16));
